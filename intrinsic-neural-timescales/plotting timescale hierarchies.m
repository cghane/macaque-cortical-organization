%% loads mean timescale values for four segments across grouped ROIs, min–max normalizes the timescales to within each segment across regions, and  saves one line+marker plot per segment for each ROI group.
